    ...
    with open(csv_filename, 'a', newline='', encoding='utf-8') as file:
        ...
        if not file_exists:
            writer.writerow([
                ...
                'article_url', 'published_at', 'scraped_at'
            ])
        ...
        try:
            ...
            for i, article_url in enumerate(new_articles):
                try:
                    ...
                    print(f"Saved article with summary successfully")
                    articles_scraped += 1
...
def main():
    print("Starting Prothom Alo News Crawler and Summarizer")
    ...
    try:
        while True:
            ...
            print(f"Total articles scraped and summarized so far: {total_articles}")
        ...
        print(f"Total articles scraped and summarized: {total_articles}")
